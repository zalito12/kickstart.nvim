...
vim.keymap.set('n', '<M-p>', ':cprev<cr>', { desc = 'Previous diagnostic' })
...
-- Terminal
vim.keymap.set('t', '<C-q>', [[<C-\><C-n>]], { desc = 'Escape para terminal y ventanas especiales' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Slightly advanced example of overiding default behavior and theme
      ...
      -- end, { desc = '[S]earch grep in all files' })
    end,
  },
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- you can unomment the following lines
